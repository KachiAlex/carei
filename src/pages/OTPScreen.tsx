...
export default function OTPScreen() {
  ...
  const handleVerify = async () => {
    ...
    setLoading(false)
    // Accept any 6-digit code for now; in production verify server-side
    if (full === '000000') {
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
        ...
        <h1 className="font-serif text-white text-3xl mb-2">Verify your number</h1>
        <p className="text-white/50 mb-8">
          Enter the 6-digit code sent to <span className="text-white/80">{phone}</span>
        </p>
