...
export function PWAInstallPrompt() {
  const { isInstallable, isIOS, isStandalone, dismissed, prompt, dismiss } = usePWAInstall()
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Tap the <Share2 className="inline w-3 h-3 mx-0.5 text-teal-400" /> Share icon in Safari, then tap
                <PlusSquare className="inline w-3 h-3 mx-0.5 text-teal-400" /> Add to Home Screen.
              </p>
            </div>
