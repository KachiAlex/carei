...
/* HERO */
.hero{background:var(--off);padding:80px 56px 80px;display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center;min-height:600px;overflow:hidden;position:relative;}
